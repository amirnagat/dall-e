...
const handleSubmit =async (e)=>{
  ...
  if (form.prompt && form.photo) {
    ...
    alert("Please enter a prompt and generate an photo");
  }
}
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create imageinaive and visually stunning images through DALLE-E AI and share them with the community  </p>
         </div>
